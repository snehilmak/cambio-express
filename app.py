...
# ── TV models live in api/Modules/TVDisplay/Models ─────────────
# First slice of the Final-phase model-extraction work. Re-export
# here so the ~30 `from app import TVDisplay, …` call sites in
# blueprints, services, and tests keep working unchanged.
